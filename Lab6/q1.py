...
access_key = "AKIAUMP7OSRUKSZ2EA5Y"
secret_key = "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"
region = "ap-south-1"

cluster_name = "First_Cluster"
service_name = "service_hello_world"
task_name = "boto_world"
...
def launch_ecs():
    ...
    response = ecs_client.register_task_definition(
        ...
        {
          "name": "wordpress",
          "image": "097711903020.dkr.ecr.us-east-2.amazonaws.com/mon",
          "essential": True,
          "portMappings": [
            {
              "containerPort": 80,
